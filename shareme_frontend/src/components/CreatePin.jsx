  ...
  const uploadImage = (e) => {
    ...
    if (type === 'image/png' || type==='image/svg' || type==='image/jpeg'|| type==='image/gif' || type==='image/tiff') {
      ...
      client.assets
        ...
        .catch((error) => { console.log('There was an error of uploading the image', error); })
    } else {
    ...
    <div className='flex flex-col justify-center items-center mt-5 lg:h-4/5'>
      ...
      <div className='flex lg:flex-row flex-col justify-center items-center bg-white lg:p-5 p-3 lg:w-4/5 w-full'>
              ...
              <label>
                <div className='flex flex-col items-center justify-center h-full'>
                  ...
                  <p className='mt-32 text-gray-400 text-sm'>
                     Use high-quailty JPG, SVG, PNG less than 20MB
                  </p>
                </div>
        ...
        <div className='flex flex-1 flex-col gap-6 lg:pl-5 mt-5 w-full'>
          ...
          <input type="text" value={about} onChange={(e)=>setAbout(e.target.value)}  placeholder="Add your description" className='outline-none text-base sm:text-lg  border-b-2  border-gray-200 p-2'/>
